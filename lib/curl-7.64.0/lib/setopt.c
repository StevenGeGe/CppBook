...
CURLcode Curl_vsetopt(struct Curl_easy *data, CURLoption option,
    ...
    switch (option) {
        ...
        case CURLOPT_SOCKS5_AUTH:
            data->set.socks5auth = va_arg(param,
            unsigned long);
        ...
        case CURLOPT_HAPROXYPROTOCOL:
             ...
             */
            data->set.haproxyprotocol = (0 != va_arg(param,
            long)) ? TRUE :
            FALSE;
            break;
        ...
        case CURLOPT_RESOLVER_START_DATA:
             ...
             */
            data->set.resolver_start_client = va_arg(param,
            void *);
            break;
        ...
        case CURLOPT_SSL_SESSIONID_CACHE:
            data->set.ssl.primary.sessionid = (0 != va_arg(param,
            long)) ?
        TRUE :
            FALSE;
      ...
      case CURLOPT_SSH_KEYDATA:
        ...
        case CURLOPT_WILDCARDMATCH:
            data->set.wildcard_enabled = (0 != va_arg(param,
            long)) ? TRUE :
            FALSE;
            break;
   ...
   defined(TCP_FASTOPEN_CONNECT)
        ...
        case CURLOPT_SUPPRESS_CONNECT_HEADERS:
            data->set.suppress_connect_headers = (0 != va_arg(param,
            long))?TRUE:
            FALSE;
            break;
        case CURLOPT_SSH_COMPRESSION:
            data->set.ssh_compression = (0 != va_arg(param,
            long))?TRUE:
            FALSE;
            break;
        ...
        case CURLOPT_DNS_SHUFFLE_ADDRESSES:
            data->set.dns_shuffle_addresses = (0 != va_arg(param,
            long)) ? TRUE:
            FALSE;
            break;
...
#ifndef CURL_DISABLE_HTTP
            data->set.trailer_data = va_arg(param,
            void *);
#endif
            break;
        default:
