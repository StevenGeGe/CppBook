        ...
        switch (option) {
            ...
            case CURLFORM_PTRNAME:
                ...
                if (!forms) {
                    value = va_arg(arg,
                    char *);
                    nameccsid = (unsigned int) va_arg(arg,
                    long);
                } else {
            ...
            case CURLFORM_COPYCONTENTS:
                ...
                if (!forms) {
                    value = va_arg(arg,
                    char *);
                    contentccsid = (unsigned int) va_arg(arg,
                    long);
                } else {
